...
import BlogsSection from "@/components/persional/blogs";
import ProjectsSection from "@/components/persional/projects";
        ...
        {activeItem.slug === "blogs" && (
          <div className="space-y-2">
            ...
            <div className="flex justify-end">
              <Button variant={'default'} size={'lg'} onClick={()=>{router.push('/editor/create-blog')}} >Create Blog</Button>
            </div>
            <BlogsSection />
          </div>
        )}
